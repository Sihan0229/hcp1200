...
# 日志文件路径和标签
log_paths = [
    "/root/autodl-tmp/hcp1200/surface/ckpts_all_multi_5/log_hemi-left_wm_0001.log",
    "/root/autodl-tmp/hcp1200/surface/ckpts_all_multi_monai/log_hemi-0.3left_wm_0001.log",
    "/root/autodl-tmp/hcp1200/surface/ckpts_all_multi_monai/log_hemi-0.1left_wm_0003.log",
    "/root/autodl-tmp/hcp1200/surface/ckpts_all_multi_repeat_5_1/log_hemi_repeat-left_wm_0001.log"
]
labels = ['T1w+T2w', 'T1w+T2w+30%MONAI', 'T1w+T2w+10%MONAI', 'T1w+T2w+Loss_repeat']
