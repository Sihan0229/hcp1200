...
# 检查数据是否匹配
assert len(t1w_paths) == len(mask_paths), "T1w 和 brainmask_fs 文件数量不匹配"
print(f"找到 {len(t1w_paths)} 个被试的数据")
...
for epoch in range(num_epochs):
    ...
    if val_loss < best_val_loss:
        ...
        model_save_path = "../model/model_seg_brain_hcp.pt"
